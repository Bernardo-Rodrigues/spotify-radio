...
describe('#View - test suite for presentation layer', () => {
    ...
    test('#changeCommandBtnsVisibility - given hide=true it should add unassigned class and reset onclink', () => {
        const view = new View()
    ...
    test('#changeCommandBtnsVisibility - given hide=false it should remove unassigned class and reset onclink', () => {
        const view = new View()
        const btn = makeBtnElement()
        jest.spyOn(
            document,
    ...
    test('#btnIsActive - should be unassined button if any of the classes are part of ignoreButtons prop', async () => {
        const view = new View()
    ...
    test('#btnIsActive - should not be unassined if none of the classes are part of ignoreButtons prop', async () => {
        const view = new View()
